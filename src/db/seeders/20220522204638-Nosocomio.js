'use strict';
const { randFirstName,randLastName,randPhoneNumber,randPassword,randEmail,randNumber, randStreetName, randCity, randCountry, randCompanyName} = require('@ngneat/falso');
...
module.exports = {
  async up (queryInterface, Sequelize) {  
    for(var i = 0;i<50;i++){
      ...
      nosocomio = {
        bussinesName: randCompanyName(),
        userId:userId,
        createdAt: new Date(),
        updatedAt: new Date()
      };

      queryInterface.bulkInsert('nosocomios', [nosocomio]);
    }
